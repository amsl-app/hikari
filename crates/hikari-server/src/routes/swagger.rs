...
#[openapi(
    paths(
        ...
        api::v0::assessment::get_assessment,
        api::v0::assessment::start,
        api::v0::assessment::get_assessment_scales,
        api::v0::assessment::get_user_scales,
        api::v0::assessment::list_user_assessments,
        api::v0::assessment::list_assessment_sessions,
        api::v0::assessment::get_session,
        ...
        api::v0::planner::create_planner_entries,
        ...
        api::v0::planner::get_milestones,
        api::v0::planner::create_milestone,
        ...
        api::v0::planner::goals::update_goal,
        api::v0::planner::goals::delete_goal,
